            ...
            else
            {
                switch(temp)
                {
                    case "1":
                        ...
                        break;
                    case "2":
                        System.out.println("Most popular Music Album: " + manager.getMostPopularMusicAlbum().getTitle() + ", with global sales of " + ((MusicAlbums) manager.getMostPopularMusicAlbum()).getGlobalSales() + " million copies");
                        break;
                    case "3":
                    ...
                    case "4":
                        ...
                        break;
                    case "5":
                        System.out.println("Shortest Movie: " + manager.getShortestMovie().getTitle() + ", with a duration of " + manager.getShortestMovie().getDuration() + " minutes");
                        break;
                    case "6":
